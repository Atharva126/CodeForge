// Fixed Coding Background
// Elements are static by default, only move when cursor is very close
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      elements.forEach((element, index) => {
        ...
        ctx.shadowBlur = distance < 50 ? 12 : 6;
        ctx.shadowOffsetX = 0;
        ctx.shadowOffsetY = 0;
        ...
        // Pulse effect only when cursor is close
        const pulse = distance < 50 ? Math.sin(time * 2 + index) * 0.1 + 1 : 1;
