...
export default function SplitPane({ left, right, minLeftSize = 25, minRightSize = 25 }: SplitPaneProps) {
    return (
        <Group orientation="horizontal" className="h-full bg-gray-950">
            ...
            <Separator className="w-1.5 bg-gray-900 hover:bg-blue-600 transition-colors cursor-col-resize flex items-center justify-center group z-10">
